  ...
  return(
    <View style={styles.container}>
      <ImageBackground style={styles.fundo} source={image}>
        <Text style={styles.paragraph}>Conversor de Temperatura</Text>
        <TextInput placeholder='Fareheint' style={styles.input} onChangeText={(e)=>setTemp(e)}></TextInput>
        <TouchableOpacity 
          style={styles.btn} 
          onPress={()=>{
            navigation.navigate('Details', {cont: temp})}
          }
        >
