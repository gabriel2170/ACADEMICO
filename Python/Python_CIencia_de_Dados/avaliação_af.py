...
Original file is located at
    https://colab.research.google.com/drive/1gL3M_oWEEk7bUU_Srjb1cyE4iX4EL5jU
...
#Iniciando tratamento da tabela para realizar a analise
...
x_treino, x_teste, y_treino, y_teste = train_test_split(x, y, test_size=0.15)
...
modelo_RL = LinearRegression() #Armazenando o modelo de analise preditiva que utiliza Regressao Linear
modelo_AD = RandomForestRegressor() #Armazenando o modelo de analise preditiva que utiliza Arvore de Decisao
...
#Mostrando grafico da tabela_aux contendo as previsoes feitas nos modelos acima
sns.histplot(data=tabela_aux)
plt.show()

#Realizando Analise de uma nova tabela 

nova_tabela1 = pd.read_excel('dadosprevisao.xls')#Importando a tabela dadosprevisaocurta.xls

display(nova_tabela1) #Mostrando dados da tabela

previsao_AD_previsao = modelo_AD.predict(nova_tabela1)#Realizando previsao da tabela nova usando modelo de Arvore de Decisao 

print('Previsao da Nova Tabela')
print(previsao_AD_previsao)#Mostrando a previsao da nova tabela

#Realizando Analise de uma nova tabela 

nova_tabela2 = pd.read_excel('dadosprevisaocurta.xls')#Importando a tabela dadosprevisaocurta.xls

display(nova_tabela2) #Mostrando dados da tabela

previsao_AD_previsaoCurta = modelo_AD.predict(nova_tabela2)#Realizando previsao da tabela nova usando modelo de Arvore de Decisao 

print('Previsao da Nova Tabela')
print(previsao_AD_previsaoCurta)#Mostrando a previsao da nova tabela